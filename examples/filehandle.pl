...
my $workbook1  = Spreadsheet::WriteExcelXML->new('fh_01.xls');
...
open TEST, "> fh_02.xls" or die "Couldn't create new Excel file: $!.\n";
...
my $workbook4  = Spreadsheet::WriteExcelXML->new(\*XLS);
...
# The Excel file is now in $xls_str. As a demonstration, print it to a file.
open    TMP, "> fh_05.xls" or die "Couldn't create new Excel file: $!.\n";
