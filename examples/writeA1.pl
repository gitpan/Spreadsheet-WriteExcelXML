...
###############################################################################
#
# This is an example of how to extend the Spreadsheet::WriteExcelXML module.
#
# Code is appended to the Spreadsheet::WriteExcelXML::Worksheet module by reusing
...
my $workbook  = Spreadsheet::WriteExcelXML->new("writeA1.xml");
...
###############################################################################
#
# The following will be appended to the Spreadsheet::WriteExcelXML::Worksheet
# package.
#
