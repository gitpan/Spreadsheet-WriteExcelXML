...
######################################################################
#
# Examples of formatting using the Spreadsheet::WriteExcelXML module
#
...
my $workbook = Spreadsheet::WriteExcelXML->new('formats.xls');
...
sub intro {
    ...
    $worksheet->write(4, 0, 'the Spreadsheet::WriteExcelXML module.', $format);
