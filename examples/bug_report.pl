...
REPORTING A BUG OR ASKING A QUESTION
    ...
    Read the documentation:
        ...
        The Spreadsheet::WriteExcelXML documentation has been refined in
    ...
    Look at the example programs:
        ...
        Spreadsheet::WriteExcelXML distribution. Many of these were created
...
I am using Spreadsheet::WriteExcelXML and I have encountered a problem. I
...
Here is some code that demonstrates the problem.
    ...
    my $workbook  = Spreadsheet::WriteExcelXML->new("reload.xls");
